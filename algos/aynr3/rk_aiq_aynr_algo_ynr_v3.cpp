...
Aynr_result_V3_t ynr_select_params_by_ISO_V3(RK_YNR_Params_V3_t *pParams, RK_YNR_Params_V3_Select_t *pSelect, Aynr_ExpInfo_V3_t *pExpInfo)
{
    ...
    pSelect->ynr_bft3x3_bypass_V3 = pParamTmp->ynr_bft3x3_bypass_V3;
    pSelect->ynr_lbft5x5_bypass_V3 = pParamTmp->ynr_lbft5x5_bypass_V3;
    pSelect->ynr_lgft3x3_bypass_V3 = pParamTmp->ynr_lgft3x3_bypass_V3;
    pSelect->ynr_flt1x1_bypass_V3 = pParamTmp->ynr_flt1x1_bypass_V3;
    pSelect->ynr_sft5x5_bypass_V3 = pParamTmp->ynr_sft5x5_bypass_V3;
    ...
    pSelect->ynr_global_gain_alpha_V3 = ratio * (pParamHi->ynr_global_gain_alpha_V3 - pParamLo->ynr_global_gain_alpha_V3) + pParamLo->ynr_global_gain_alpha_V3;
    pSelect->ynr_global_gain_V3       = ratio * (pParamHi->ynr_global_gain_V3 - pParamLo->ynr_global_gain_V3) + pParamLo->ynr_global_gain_V3;
    pSelect->ynr_gain_adjust_thresh_V3 = ratio * (pParamHi->ynr_gain_adjust_thresh_V3 - pParamLo->ynr_gain_adjust_thresh_V3) + pParamLo->ynr_gain_adjust_thresh_V3;
    pSelect->ynr_gain_adjust_scale_V3 = ratio * (pParamHi->ynr_gain_adjust_scale_V3 - pParamLo->ynr_gain_adjust_scale_V3) + pParamLo->ynr_gain_adjust_scale_V3;

    // get rnr parameters
    for (int i = 0; i < 17; i++)
    {
        pSelect->ynr_rnr_strength_V3[i] = ratio * (pParamHi->ynr_rnr_strength_V3[i] - pParamLo->ynr_rnr_strength_V3[i]) + pParamLo->ynr_rnr_strength_V3[i];
    }
    ...
    for (int i = 0; i < 2; i++)
    {
        pSelect->ciISO_V3[i] = ratio * (pParamHi->ciISO_V3[i] - pParamLo->ciISO_V3[i]) + pParamLo->ciISO_V3[i];
    }

    // noise curve
    for (int i = 0; i < YNR_V3_ISO_CURVE_POINT_NUM; i++)
    {
        pSelect->noiseSigma_V3[i] = ratio * (pParamHi->noiseSigma_V3[i] - pParamLo->noiseSigma_V3[i]) + pParamLo->noiseSigma_V3[i];
        pSelect->lumaPoints_V3[i] = (short)(ratio * (pParamHi->lumaPoints_V3[i] - pParamLo->lumaPoints_V3[i]) + pParamLo->lumaPoints_V3[i]);
    }

    for (int i = 0; i < 6; i++)
    {
        pSelect->loFreqLumaNrCurvePoint[i] = ratio * (pParamHi->loFreqLumaNrCurvePoint[i] - pParamLo->loFreqLumaNrCurvePoint[i]) + pParamLo->loFreqLumaNrCurvePoint[i];
        pSelect->loFreqLumaNrCurveRatio[i] = ratio * (pParamHi->loFreqLumaNrCurveRatio[i] - pParamLo->loFreqLumaNrCurveRatio[i]) + pParamLo->loFreqLumaNrCurveRatio[i];

        pSelect->loFreqLumaNrCurvePoint[i] *= 4; // curve point 8 bits -> 10 bits
    }

    // lo bf
    for (int i = 0; i < 2; i++)
    {
        pSelect->ynr_low_bf_V3[i] = ratio * (pParamHi->ynr_low_bf_V3[i] - pParamLo->ynr_low_bf_V3[i]) + pParamLo->ynr_low_bf_V3[i];
    }

    pSelect->ynr_low_thred_adj_V3 = ratio * (pParamHi->ynr_low_thred_adj_V3 - pParamLo->ynr_low_thred_adj_V3) + pParamLo->ynr_low_thred_adj_V3;
    pSelect->ynr_low_peak_supress_V3 = ratio * (pParamHi->ynr_low_peak_supress_V3 - pParamLo->ynr_low_peak_supress_V3) + pParamLo->ynr_low_peak_supress_V3;
    pSelect->ynr_low_edge_adj_thresh_V3 = ratio * (pParamHi->ynr_low_edge_adj_thresh_V3 - pParamLo->ynr_low_edge_adj_thresh_V3) + pParamLo->ynr_low_edge_adj_thresh_V3;
    pSelect->ynr_low_bi2_weight_thresh_V3 = ratio * (pParamHi->ynr_low_bi2_weight_thresh_V3 - pParamLo->ynr_low_bi2_weight_thresh_V3) + pParamLo->ynr_low_bi2_weight_thresh_V3;
    pSelect->ynr_low_center_weight_V3 = ratio * (pParamHi->ynr_low_center_weight_V3 - pParamLo->ynr_low_center_weight_V3) + pParamLo->ynr_low_center_weight_V3;
    pSelect->ynr_low_dist_adj_V3 = ratio * (pParamHi->ynr_low_dist_adj_V3 - pParamLo->ynr_low_dist_adj_V3) + pParamLo->ynr_low_dist_adj_V3;
    pSelect->ynr_low_weight_V3 = ratio * (pParamHi->ynr_low_weight_V3 - pParamLo->ynr_low_weight_V3) + pParamLo->ynr_low_weight_V3;

    pSelect->ynr_low_filt1_strength_V3 = ratio * (pParamHi->ynr_low_filt1_strength_V3 - pParamLo->ynr_low_filt1_strength_V3) + pParamLo->ynr_low_filt1_strength_V3;
    pSelect->ynr_low_filt2_strength_V3 = ratio * (pParamHi->ynr_low_filt2_strength_V3 - pParamLo->ynr_low_filt2_strength_V3) + pParamLo->ynr_low_filt2_strength_V3;

    pSelect->ynr_low_bi_weight_V3 = ratio * (pParamHi->ynr_low_bi_weight_V3 - pParamLo->ynr_low_bi_weight_V3) + pParamLo->ynr_low_bi_weight_V3;

    // High Freq
    pSelect->ynr_base_filter_weight1_V3 = ratio * (pParamHi->ynr_base_filter_weight1_V3 - pParamLo->ynr_base_filter_weight1_V3) + pParamLo->ynr_base_filter_weight1_V3;
    pSelect->ynr_base_filter_weight2_V3 = ratio * (pParamHi->ynr_base_filter_weight2_V3 - pParamLo->ynr_base_filter_weight2_V3) + pParamLo->ynr_base_filter_weight2_V3;
    pSelect->ynr_base_filter_weight3_V3 = ratio * (pParamHi->ynr_base_filter_weight3_V3 - pParamLo->ynr_base_filter_weight3_V3) + pParamLo->ynr_base_filter_weight3_V3;


    pSelect->ynr_high_thred_adj_V3 = ratio * (pParamHi->ynr_high_thred_adj_V3 - pParamLo->ynr_high_thred_adj_V3) + pParamLo->ynr_high_thred_adj_V3;
    pSelect->ynr_high_weight_V3 = ratio * (pParamHi->ynr_high_weight_V3 - pParamLo->ynr_high_weight_V3) + pParamLo->ynr_high_weight_V3;

    for (int i = 0; i < 8; i++)
    {
        pSelect->ynr_direction_weight_V3[i] = ratio * (pParamHi->ynr_direction_weight_V3[i] - pParamLo->ynr_direction_weight_V3[i]) + pParamLo->ynr_direction_weight_V3[i];
    }
    pSelect->ynr_hi_min_adj_V3 = ratio * (pParamHi->ynr_hi_min_adj_V3 - pParamLo->ynr_hi_min_adj_V3) + pParamLo->ynr_hi_min_adj_V3;
    pSelect->ynr_hi_edge_thed_V3 = ratio * (pParamHi->ynr_hi_edge_thed_V3 - pParamLo->ynr_hi_edge_thed_V3) + pParamLo->ynr_hi_edge_thed_V3;

    for (int i = 0; i < 6; i++)
    {
        pSelect->hiFreqLumaNrCurvePoint[i] = ratio * (pParamHi->hiFreqLumaNrCurvePoint[i] - pParamLo->hiFreqLumaNrCurvePoint[i]) + pParamLo->hiFreqLumaNrCurvePoint[i];
        pSelect->hiFreqLumaNrCurveRatio[i] = ratio * (pParamHi->hiFreqLumaNrCurveRatio[i] - pParamLo->hiFreqLumaNrCurveRatio[i]) + pParamLo->hiFreqLumaNrCurveRatio[i];

        pSelect->hiFreqLumaNrCurvePoint[i] *= 4; // curve point 8 bits -> 10 bits
    }
...
Aynr_result_V3_t ynr_fix_transfer_V3(RK_YNR_Params_V3_Select_t* pSelect, RK_YNR_Fix_V3_t *pFix, float fStrength, Aynr_ExpInfo_V3_t *pExpInfo)
{
    ...
    pFix->ynr_sft5x5_bypass = pSelect->ynr_sft5x5_bypass_V3;
    pFix->ynr_flt1x1_bypass = pSelect->ynr_flt1x1_bypass_V3;
    pFix->ynr_lgft3x3_bypass = pSelect->ynr_lgft3x3_bypass_V3;
    pFix->ynr_lbft5x5_bypass = pSelect->ynr_lbft5x5_bypass_V3;
    pFix->ynr_bft3x3_bypass = pSelect->ynr_bft3x3_bypass_V3;
    ...
    tmp = (int)(1.0f / pSelect->ynr_low_bf_V3[1] / fStrength * (1 << 9));
    pFix->ynr_low_bf_inv[1] = CLIP(tmp, 0, 0x3fff);
    tmp = (int)(1.0f / pSelect->ynr_low_bf_V3[0] / fStrength * (1 << 9));
    pFix->ynr_low_bf_inv[0] = CLIP(tmp, 0, 0x3fff);


    // YNR_2700_LOWNR_CTRL1  (0x0014)
    tmp = (int)(pSelect->ynr_low_peak_supress_V3 / fStrength * (1 << 7));
    pFix->ynr_low_peak_supress = CLIP(tmp, 0, 0x80);
    tmp = (int)(pSelect->ynr_low_thred_adj_V3  * (1 << 6));
    pFix->ynr_low_thred_adj = CLIP(tmp, 0, 0x7ff);

    // YNR_2700_LOWNR_CTRL2 (0x0018)
    tmp = (int)(pSelect->ynr_low_dist_adj_V3 * (1 << 2));
    pFix->ynr_low_dist_adj = CLIP(tmp, 0, 0x1ff);
    tmp = (int)(pSelect->ynr_low_edge_adj_thresh_V3);
    pFix->ynr_low_edge_adj_thresh = CLIP(tmp, 0, 0x3ff);


    // YNR_2700_LOWNR_CTRL3 (0x001c)
    tmp = (int)(pSelect->ynr_low_bi_weight_V3 * fStrength * (1 << 7));
    pFix->ynr_low_bi_weight = CLIP(tmp, 0, 0x80);
    tmp = (int)(pSelect->ynr_low_weight_V3 *  fStrength * (1 << 7));
    pFix->ynr_low_weight = CLIP(tmp, 0, 0x80);
    tmp = (int)(pSelect->ynr_low_center_weight_V3 / fStrength * (1 << 10));
    pFix->ynr_low_center_weight = CLIP(tmp, 0, 0x400);

    // YNR_2700_HIGHNR_CTRL0 (0x0020)
    tmp = (int)(pSelect->ynr_hi_min_adj_V3 / fStrength * (1 << 6));
    pFix->ynr_hi_min_adj = CLIP(tmp, 0, 0x3f);
    tmp = (int)(pSelect->ynr_high_thred_adj_V3 * fStrength * (1 << 6));
    pFix->ynr_high_thred_adj = CLIP(tmp, 0, 0x7ff);

    // YNR_2700_HIGHNR_CTRL1  (0x0024)
    tmp = (1 << 7) - (int)(pSelect->ynr_high_weight_V3 * fStrength * (1 << 7));
    pFix->ynr_high_retain_weight = CLIP(tmp, 0, 0x80);
    tmp = (int)(pSelect->ynr_hi_edge_thed_V3 / fStrength);
    pFix->ynr_hi_edge_thed = CLIP(tmp, 0, 0xff);

    // YNR_2700_HIGHNR_BASE_FILTER_WEIGHT  (0x0028)
    w2 = int(pSelect->ynr_base_filter_weight3_V3 * 64 / 2 + 0.5);
    w1 = int(pSelect->ynr_base_filter_weight2_V3 * 64 / 2 + 0.5);
    w0 = 64 - w1 * 2 - w2 * 2;
    ...
    float filter2_sigma = pSelect->ynr_low_filt2_strength_V3;
    ...
    for (int i = 0; i < 8; i++) {
        tmp = (int)(pSelect->ynr_direction_weight_V3[i] * (1 << 4));
    ...
    for (int i = 0; i < 17; i++) {
        tmp = int(pSelect->ynr_rnr_strength_V3[i] * 16);
...
Aynr_result_V3_t ynr_init_params_json_V3(RK_YNR_Params_V3_t *pYnrParams, CalibDbV2_YnrV3_t *pCalibdbV2, int calib_idx, int tuning_idx)
{
    ...
    for(j = 0; j < pCalibdbV2->CalibPara.Setting[tuning_idx].Calib_ISO_len && j < RK_YNR_V3_MAX_ISO_NUM ; j++) {
        ...
        for (i = 0; i < YNR_V3_ISO_CURVE_POINT_NUM; i++) {
            ...
            pYnrParams->arYnrParamsISO[j].lumaPoints_V3[i] = (short)ave1;
            ave2 = ave1 * ave1;
            ave3 = ave2 * ave1;
            ave4 = ave3 * ave1;
            pYnrParams->arYnrParamsISO[j].noiseSigma_V3[i] = pCalibISO->sigma_curve[0] * ave4
                    + pCalibISO->sigma_curve[1] * ave3
                    + pCalibISO->sigma_curve[2] * ave2
                    + pCalibISO->sigma_curve[3] * ave1
                    + pCalibISO->sigma_curve[4];

            if (pYnrParams->arYnrParamsISO[j].noiseSigma_V3[i] < 0) {
                pYnrParams->arYnrParamsISO[j].noiseSigma_V3[i] = 0;
            }

            if (bit_shift > 0) {
                pYnrParams->arYnrParamsISO[j].lumaPoints_V3[i] >>= bit_shift;
            } else {
                pYnrParams->arYnrParamsISO[j].lumaPoints_V3[i] <<= ABS(bit_shift);
            }
        }

        pYnrParams->arYnrParamsISO[j].ciISO_V3[0] = pCalibISO->ynr_lci;
        pYnrParams->arYnrParamsISO[j].ciISO_V3[1] = pCalibISO->ynr_hci;
    }
    ...
    for(j = 0; j < pCalibdbV2->TuningPara.Setting[tuning_idx].Tuning_ISO_len && j < RK_YNR_V3_MAX_ISO_NUM; j++) {
        ...
        for(i = 0; i < 17; i++) {
            pYnrParams->arYnrParamsISO[j].ynr_rnr_strength_V3[i] = pISO->rnr_strength[i];
        }
        ...
        pYnrParams->arYnrParamsISO[j].ynr_lbft5x5_bypass_V3 = pISO->ynr_lbft5x5_bypass;
        pYnrParams->arYnrParamsISO[j].ynr_lgft3x3_bypass_V3 = pISO->ynr_lgft3x3_bypass;
        pYnrParams->arYnrParamsISO[j].ynr_flt1x1_bypass_V3 = pISO->ynr_flt1x1_bypass;
        pYnrParams->arYnrParamsISO[j].ynr_sft5x5_bypass_V3 = pISO->ynr_sft5x5_bypass;

        pYnrParams->arYnrParamsISO[j].ynr_low_bf_V3[0] = pISO->low_bf1;
        pYnrParams->arYnrParamsISO[j].ynr_low_bf_V3[1] = pISO->low_bf2;
        pYnrParams->arYnrParamsISO[j].ynr_low_thred_adj_V3 = pISO->low_thred_adj;
        pYnrParams->arYnrParamsISO[j].ynr_low_peak_supress_V3 = pISO->low_peak_supress;
        pYnrParams->arYnrParamsISO[j].ynr_low_edge_adj_thresh_V3 = pISO->low_edge_adj_thresh;
        pYnrParams->arYnrParamsISO[j].ynr_low_bi2_weight_thresh_V3 = pISO->low_lbf_weight_thresh;
        pYnrParams->arYnrParamsISO[j].ynr_low_center_weight_V3 = pISO->low_center_weight;
        pYnrParams->arYnrParamsISO[j].ynr_low_dist_adj_V3 = pISO->low_dist_adj;
        pYnrParams->arYnrParamsISO[j].ynr_low_weight_V3 = pISO->low_weight;
        pYnrParams->arYnrParamsISO[j].ynr_low_filt1_strength_V3 = pISO->low_filt1_strength;
        pYnrParams->arYnrParamsISO[j].ynr_low_filt2_strength_V3 = pISO->low_filt2_strength;
        pYnrParams->arYnrParamsISO[j].ynr_low_bi_weight_V3 = pISO->low_bi_weight;

        pYnrParams->arYnrParamsISO[j].ynr_base_filter_weight1_V3 = pISO->base_filter_weight1;
        pYnrParams->arYnrParamsISO[j].ynr_base_filter_weight2_V3 = pISO->base_filter_weight2;
        pYnrParams->arYnrParamsISO[j].ynr_base_filter_weight3_V3 = pISO->base_filter_weight3;
        pYnrParams->arYnrParamsISO[j].ynr_high_thred_adj_V3 = pISO->high_thred_adj;
        pYnrParams->arYnrParamsISO[j].ynr_high_weight_V3 = pISO->high_weight;
        for(i = 0; i < 8; i++) {
            pYnrParams->arYnrParamsISO[j].ynr_direction_weight_V3[i] = pISO->high_direction_weight[i];
        }
        pYnrParams->arYnrParamsISO[j].ynr_hi_min_adj_V3 = pISO->hi_min_adj;
        pYnrParams->arYnrParamsISO[j].ynr_hi_edge_thed_V3 = pISO->hi_edge_thed;

        //global gain
        pYnrParams->arYnrParamsISO[j].ynr_global_gain_alpha_V3 = pISO->ynr_global_gain_alpha;
        pYnrParams->arYnrParamsISO[j].ynr_global_gain_V3 = pISO->ynr_global_gain;
        pYnrParams->arYnrParamsISO[j].ynr_gain_adjust_thresh_V3 = pISO->ynr_adjust_thresh;
        pYnrParams->arYnrParamsISO[j].ynr_gain_adjust_scale_V3 = pISO->ynr_adjust_scale;
    }
