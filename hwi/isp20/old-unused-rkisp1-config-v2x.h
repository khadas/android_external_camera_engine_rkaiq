...
#ifndef _UAPI_RKISP1_CONFIG_V2X_H
#define _UAPI_RKISP1_CONFIG_V2X_H
...
#define ISP2X_RAWAWB_STORE_LS_WPFLAG_NUM 3
...
#define ISP2X_WBGAIN_FIXSCALE_BIT  10
...
struct isp2x_rawaelite_meas_cfg {
    u8 rawae_sel;
    u8 wnd_num;
    // NOTE: latest register tables don't have rgb2y coeff in rawae
    struct isp2x_window win;
} __attribute__ ((packed));
...
struct isp2x_isp_meas_cfg {
    struct isp2x_siawb_meas_cfg awb_v100;
    struct isp2x_rawawb_meas_cfg awb_v200;
...
struct isp2x_rawawb_ramdata {
    ...
    u32 g;
    u32 b;
    u8 isWP[ISP2X_RAWAWB_STORE_LS_WPFLAG_NUM];
};
 ...
 */
struct rkisp1_isp2x_stat_buffer {
    unsigned int meas_type;
    unsigned int frame_id;
    struct isp2x_stat params;
} __attribute__ ((packed));

#endif /* _UAPI_RKISP1_CONFIG_V2X_H */
