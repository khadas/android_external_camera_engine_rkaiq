...
void get_dbg_force_disable_mods_env()
{
    ...
    LOGE("ALL_ISP_MODULES %d, ALL_ISPP_MODULES %d,ONLY_INIT_PARAMS %d",
         ALL_ISP_MODULES, ALL_ISPP_MODULES, ONLY_INIT_PARAMS);
    LOGE("g_bypass_module_params 0x%llx", g_bypass_module_params);
    ...
    LOGE("isp(en:0x%llx, cfg_up:0x%llx, bypass:%d),\n"
