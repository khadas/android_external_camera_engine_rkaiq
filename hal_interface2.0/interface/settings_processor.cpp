 ...
 * Author: Randy <randy.wang@rock-chips.com>
 */
                                   ...
                                   int sensorOutputWidth, int sensorOutputHeight)
{
    ...
    CameraMetadata& staticMeta = AiqCameraHalAdapter::get_static_metadata();
                                     ...
                                     AiqInputParams *aiqInputParams)
{
    ...
    LOGI("@%s %d: aeParams (%p) aeParams->mode(%d)", __FUNCTION__, __LINE__, aeParams, aeParams->mode);
    // ******** metering_mode
